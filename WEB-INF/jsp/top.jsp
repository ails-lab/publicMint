...
<link rel="stylesheet" type="text/css" href="css/enrichment.css"/>
...
<script type="text/javascript" src="js/vue/datasetTransformationItem.js"></script>
<script type="text/javascript" src="js/vue/statisticsComponent.js"></script>
<script type="text/javascript" src="js/vue/translateNormalizationComponent.js"></script>
<script type="text/javascript" src="js/vue/enrichmentValuesComponent.js"></script>
<script type="text/javascript" src="js/vue/annotationFilter.js"></script>
<script type="text/javascript" src="js/vue/atomicFilterEditor.js"></script>
<script type="text/javascript" src="js/vue/combineFilterEditor.js"></script>
<script type="text/javascript" src="js/vue/listEnrichments.js"></script>
<script type="text/javascript" src="js/vue/enrichmentStatsComponent.js"></script>
<script type="text/javascript" src="js/vue/listTranslations.js"></script>
...
<script type="text/javascript" src="js/enrichRequest.js"></script>
...
<body>
<%@ include file="templates/statisticsComponentTemplate.html"%>
<%@ include file="templates/translateNormalizationComponentTemplate.html"%>
<%@ include file="templates/enrichmentValuesComponentTemplate.html"%>
<%@ include file="templates/annotationFilterComponentTemplate.html"%>
<%@ include file="templates/atomicFilterEditorComponentTemplate.html"%>
<%@ include file="templates/combineFilterEditorComponentTemplate.html"%>
<%@ include file="templates/listEnrichmentsComponentTemplate.html"%>
<%@ include file="templates/enrichmentStatsComponentTemplate.html"%>
<%@ include file="templates/listTranslationsComponentTemplate.html"%>
