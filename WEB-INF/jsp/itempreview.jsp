 ...
 <div class="block-nav">
   ...
   <s:if test="hasActionErrors()==true">
		...
		<s:iterator value="actionErrors">
			<div class="errorMessage" style="margin-top: 20px;padding:10px;"><s:property escapeHtml="false" /> </div>
		</s:iterator>
	</s:if>	
	<s:else>
  <div> 
				...
				<s:if test="output.type=='jsp'">
				  <s:set var="theUrl" value="%{output.url}" scope="request"></s:set>
				  <jsp:useBean id="theUrl" class="java.lang.String" scope="request" ></jsp:useBean>
				  <s:set var="theContent" value="%{output.content}" scope="request"></s:set>
