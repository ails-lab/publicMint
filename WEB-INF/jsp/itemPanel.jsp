...
<s:if test="hasActionMessages()">
		<s:iterator value="actionMessages">
			<div id="message<s:property value="userId"/>_<s:property value="orgId"/>" style="width: 390px;height:20px;padding:3px;"><font color="red"><s:property escapeHtml="false" /> </font></div>
		</s:iterator>
	</s:if>	
