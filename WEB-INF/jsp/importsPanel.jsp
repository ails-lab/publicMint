...
<s:if test="hasActionMessages()">
		<s:iterator value="actionMessages">
			<div class="message" style="width: 390px;height:20px;padding:3px;"><font color="red"><s:property escapeHtml="false" /> </font></div>
		</s:iterator>
	</s:if>	
	<div class="summary"></div>
	 ...
	 <form id="importsPanelform" name='imports_<s:property value="userId"/>_<s:property value="orgId"/>'>
		 <s:iterator var="impt" value="imports">
		 				...
		 				$K.kaiten('load',{kConnector:'html.page', url:'DatasetOptions_input.action?uploadId=<s:property value="dbID"/>&userId=<s:property value="userId"/>&organizationId=<s:property value="orgId"/>', kTitle:'Dataset Options' });"
						...
						<s:if test="folderNum>0">
						    <s:iterator var="lbl" value="labels">
...
<div id="currentPage" style="display:none;"> <s:property value="currentPage" /> </div>
...
$("div#"+<s:property value="dsId"/>).toggleClass('k-active');
