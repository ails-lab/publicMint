...
public class XpathHolder implements TraversableI {
	...
	public String getFullPath() {
		String withPrefixes = getXpathWithPrefix(true);
		return XPathUtils.expandNamespaces(withPrefixes, GlobalPrefixStore.allPrefixMap());
	}
	...
	public List<XpathStatsValues.ValueStat> getValues( long start, int maxCount ) {
		if(dataset instanceof AnnotatedDataset)
			return Solarizer.getValues(this, start, maxCount);
		else
