...
//			
	...
	/**
	 * For all xpaths in the dataset, find identical named xpaths in the target Mapping (this mapping)
	 * and create an xpath type mapping. Makes sense for same schema in ds than target, but what if this dataset
	 * misses some xpaths? The mapping will be incomplete.
	 * @param ds
	 */
	...
	/**
	 * Arne: Insert the automated mappings into the mapping json. The dataset is only used to
	 * aquire information about Id/Label/ItemRoot paths. If that differs from schema, things will
	 * get funny.
	 * @param ds
	 */
	...
	public static List<Mapping> getRecentMappings(Dataset dataset, List<Mapping> mappings) {
		...
		log.debug( "Recent Mappings: " + result );
		return result;
	}
