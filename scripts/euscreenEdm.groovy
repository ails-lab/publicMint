...
for(Element rights: rightElements) {
    ...
    rights.addEnumeration("http://rightsstatements.org/vocab/NoC-NC/1.0/");
	rights.addEnumeration("http://rightsstatements.org/vocab/NoC-OKLR/1.0/");
	rights.addEnumeration("http://creativecommons.org/publicdomain/zero/1.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by/4.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by-sa/4.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by-nd/4.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by-nc/4.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by-nc-sa/4.0/");
	rights.addEnumeration("http://creativecommons.org/licenses/by-nc-nd/4.0/");
	rights.addEnumeration("http://rightsstatements.org/vocab/InC/1.0/");
	rights.addEnumeration("http://rightsstatements.org/vocab/InC-EDU/1.0/");
	rights.addEnumeration("http://rightsstatements.org/vocab/InC-OW-EU/1.0/");
	rights.addEnumeration("http://rightsstatements.org/vocab/CNE/1.0/");
}


provider = template.findFirst("//edm:provider");
provider.addConstantMapping("EUscreen");
...
dataPr.addEnumeration("NRK");
dataPr.addEnumeration("RHUL");
dataPr.addEnumeration("Royal Holloway University London");
dataPr.addEnumeration("BUFVC");
dataPr.addEnumeration("Istituto Luce - Cinecittà");
dataPr.addEnumeration("ELTE");
dataPr.addEnumeration("Kungliga biblioteket");
...
dataPr.addEnumeration("Deutsche Welle");
dataPr.addEnumeration("RTBF");
dataPr.addEnumeration("ČT");
dataPr.addEnumeration("MU");
dataPr.addEnumeration("TVR");
dataPr.addEnumeration("Romanian Television");
...
dataPr.addEnumeration("Narodowy Instytut Audiowizualny");
dataPr.addEnumeration("Screen Archive South East");
dataPr.addEnumeration("RTÉ");
dataPr.addEnumeration("VRT");
dataPr.addEnumeration("DR");
dataPr.addEnumeration("NAVA");
dataPr.addEnumeration("London’s Screen Archives");
dataPr.addEnumeration("ERT SA");
dataPr.addEnumeration("East Anglian Film Archive");
dataPr.addEnumeration("Music Library of Greece of The Friends of Music Society");
dataPr.addEnumeration("The National Archives of Latvia");
dataPr.addEnumeration("TV3 Televisió de Catalunya (TVC)");
dataPr.addEnumeration("Netherlands Institute for Sound and Vision");
dataPr.addEnumeration("Netherlands Institute for Sound & Vision");
dataPr.addEnumeration("Northern Ireland Screen");
dataPr.addEnumeration("RTV Vojvodina");
dataPr.addEnumeration("RTVE");
dataPr.addEnumeration("HRT");
dataPr.addEnumeration("AQSHF Albania");


// changes necessary
// "DW" -> "Deutsche Welle", "NINA" -> "Narodowy Instytut Audiowizualny",
// "SASE" -> "Screen Archive South East", "CT" -> "ČT", "KB" -> "Kungliga biblioteket", 
// "RTE" -> "RTÉ"
